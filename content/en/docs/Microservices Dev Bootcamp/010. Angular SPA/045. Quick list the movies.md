...
~~~
npx ng generate service core/singleton-services/backend
~~~

...which may be abbreviated to...

~~~
npx ng g service service core/singleton-services/backend
~~~

At this point we'd inspect the changes made to:

~~~
src\app\core\singleton-services\backend.service.spec.ts
src\app\core\singleton-services\backend.service.ts
~~~

Commit with comment "ng g service service backend"
